...
def perfil(root, GoMain, GoPuntajes, cerrar_todo, configurar_ventana,
    ...
    panel = tk.Frame(
        window1,
        bg=COLOR_PANEL,
        highlightbackground=COLOR_DORADO,
    ...
    subtitulo = tk.Label(
        panel,
        text="Resumen de trayectoria y victorias por rol",
        font=("Arial", 12, "bold"),
        bg=COLOR_PANEL,
        fg=COLOR_SUAVE
    )
    ...
    if datos_jugador is not None:
        ...
        tarjeta_usuario = tk.Frame(
            contenido,
            bg=COLOR_PANEL_CLARO,
            highlightbackground="#111821",
        ...
        tk.Label(
            tarjeta_usuario,
            text=datos_jugador["nombre_usuario"],
            font=("Arial", 24, "bold"),
            bg=COLOR_PANEL_CLARO,
            fg=COLOR_DORADO
        ).pack(pady=(0, 12))
        ...
        tk.Label(
            panel,
            text="No se encontró información del jugador actual.",
            font=("Arial", 16, "bold"),
            bg=COLOR_PANEL,
            fg=COLOR_SUAVE
        ).pack(expand=True)
