...
def mapa(root, GoPlay, cerrar_todo, configurar_ventana):
    """
    Descripción:
    ...
    caja_informacion_contrincante.insert(tk.END, "Información contrincante")
